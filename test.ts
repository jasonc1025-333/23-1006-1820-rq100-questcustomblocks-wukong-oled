...
input.onButtonPressed(Button.A, function () {
    ...
    //// jwc ? serial.writeLine('* 0: ' + convertToText(network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal) + " " + convertToText(network_Send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_Quest_Global) + " " + convertToText(control.deviceSerialNumber()))
    //// jwc ? serial.writeLine('* 0: ' + convertToText(quest_Pub network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal) + " " + convertToText(network_Send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_Quest_Global) + " " + convertToText(control.deviceSerialNumber()))
...
input.onButtonPressed(Button.B, function () {
    ...
    serial.writeLine('* 5: ' + convertToText(network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal) + " " + convertToText(network_Send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_Quest_Global) + " " + convertToText(control.deviceSerialNumber()))
    //// jwc ? serial.writeLine('* 6: ' + convertToText(quest_Public_Variables_N_Constants.network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal_01) + " " + convertToText(quest_Public_Variables_N_Constants_01.prototype.network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal_02))
    serial.writeLine('* 6: ' + convertToText(network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal))
    serial.writeLine('* 6_01: ' + convertToText(quest_Public_Variables_N_Constants.network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal_01))
    serial.writeLine('* 6_11: ' + convertToText(quest_Dashboard.network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal_11))
})
...
basic.forever(function () {
    ...
    //// jwc yy serial.writeLine('* 1: ' + convertToText(network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal) + " " + convertToText(network_Send_DataOfBot_ToXrayDashboardOfMb_Enum_QuestGlobal) + " " + convertToText(control.deviceSerialNumber()))    
