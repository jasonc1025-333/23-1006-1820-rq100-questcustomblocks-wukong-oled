...
let motor_Power_WL_QuestGlobal = ""
let motor_Power_WR_QuestGlobal = ""
let motor_Power_WL2_QuestGlobal = ""
let motor_Power_WR2_QuestGlobal = ""
let servoArm_Degrees_S7_Left_QuestGlobal = ""
let servoArm_Degrees_S6_Right_QuestGlobal = ""
    ...
    export function quest_Set_PowerMotorsViaBlueRedBlackPins_Func(portIdsIn: quest_PortGroup_BlueRedBlack_PortIds_Enum, powerLeftIn: number, powerRightIn: number): void {
        ...
        switch (portIdsIn) {
            case quest_PortGroup_BlueRedBlack_PortIds_Enum.S1_MotorWheel_Left__S0_MotorWheel_Right:
                ...
                //// jwc 25-1012-2000 message_Mini_Network_Str = "1" + convertToText(powerLeftIn) + "0" + convertToText(powerRightIn)
                //// jwc 25-1012-2030 with neg #, could exceed network_max_length: message_Mini_Network_Str = "1:" + convertToText(powerLeftIn) + ",0:" + convertToText(powerRightIn)
                //// jwc 25-1012-2200 y message_Mini_Network_Str = "1" + convertToText(powerLeftIn) + ",0" + convertToText(powerRightIn)
                //// jwc 25-1012-2200 y message_Full_Display_Str = "Wheel_L: " + convertToText(powerLeftIn) + ", Wheel_R: " + convertToText(powerRightIn)
                ...
                //// jwc 25-1012-2200 Since Message_Length_Max is limited, Not Combine both Motors \/\/
            ...
            case quest_PortGroup_BlueRedBlack_PortIds_Enum.S3_MotorWheel_Left__S2_MotorWheel_Right:
                ...
                // jwc 26-0710-2300: DriverDashboard (ETA) capture for OLED WL2/WR2 row
                motor_Power_WL2_QuestGlobal = "" + powerLeftIn
                motor_Power_WR2_QuestGlobal = "" + powerRightIn
                //// * jwc 25-0626-1400 if (network_Send_DataOfBot_ToXrayDashboard_OnRemoteDisplay_OnOff_Enum_QuestGlobal == quest_Toggle_OnOff_Enum.On) {
                ...
                //// jwc 25-1012-2000 message_Mini_Network_Str = "3" + convertToText(powerLeftIn) + "2" + convertToText(powerRightIn)
                //// jwc 25-1012-2030 with neg #, could exceed network_max_length: message_Mini_Network_Str = "3:" + convertToText(powerLeftIn) + ",2:" + convertToText(powerRightIn)
                //// jwc 25-1012-2200 y message_Mini_Network_Str = "3" + convertToText(powerLeftIn) + ",2" + convertToText(powerRightIn)
                //// jwc 25-1012-2200 y message_Full_Display_Str = "Wheel_2_L: " + convertToText(powerLeftIn) + ", Wheel_2_R: " + convertToText(powerRightIn)
        ...
        //// jwc 25-1012-2200 Since Message_Length_Max is limited, Not Combine both Motors y quest_Dashboard.quest_Dashboard_Network_SendData_WithMyBotHeader_Func(message_Mini_Network_Str)
        //// jwc 25-1012-2200 Since Message_Length_Max is limited, Not Combine both Motors y quest_Dashboard.quest_Show_String_For_Oled_SmallFont_Func(message_Full_Display_Str, 0, 1)
    ...
    export function quest_Set_Degrees_By_Menu_ForServoArm_SMALL_Func(port_Id_In: quest_PortSingle_ServoArmBeam_PortId_Enum, servoArm_DegreesInDirection_Enum_In: quest_ServoArm_DegreesInDirection_Enum, debug_Show_In: quest_Debug_Show_Enum): void {
        ...
        switch (port_Id_In) {
            case quest_PortSingle_ServoArmBeam_PortId_Enum.S7_ServoArm_Left:
                ...
                // jwc 26-0710-2300: DriverDashboard (ETA) capture for OLED AL row
                servoArm_Degrees_S7_Left_QuestGlobal = "" + servoArm_Degrees_Local
                //// jwc 25-0626-1400 if (network_Send_DataOfBot_ToXrayDashboard_OnRemoteDisplay_OnOff_Enum_QuestGlobal == quest_Toggle_OnOff_Enum.On) {
                //// jwc 25-0626-1400     //// jwc y quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("A:" + convertToText(network_GroupChannel_OfXrayDashboard_OnRemoteDisplay_BASE0_INT_QUESTGLOBAL +",L:" + convertToText(powerLeftIn) +",R:" + convertToText(powerRightIn)), quest_Debug_Show_Enum.Dashboard_OLED)
            ...
            case quest_PortSingle_ServoArmBeam_PortId_Enum.S6_ServoArm_Right:
                ...
                // jwc 26-0710-2300: DriverDashboard (ETA) capture for OLED AR row
                servoArm_Degrees_S6_Right_QuestGlobal = "" + servoArm_Degrees_Local
                //// jwc 25-0626-1400 if (network_Send_DataOfBot_ToXrayDashboard_OnRemoteDisplay_OnOff_Enum_QuestGlobal == quest_Toggle_OnOff_Enum.On) {
                //// jwc 25-0626-1400     //// jwc y quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("A:" + convertToText(network_GroupChannel_OfXrayDashboard_OnRemoteDisplay_BASE0_INT_QUESTGLOBAL +",L:" + convertToText(powerLeftIn) +",R:" + convertToText(powerRightIn)), quest_Debug_Show_Enum.Dashboard_OLED)
                //// jwc 25-0626-1400     //// jwc ny quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("C:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",Arm_Port:" + convertToText(port_Id_In) + ",Arm_Deg:" + convertToText(servoArm_DegreesInDirection_Enum_In)), quest_Debug_Show_Enum.Dashboard_OLED)
                //// jwc 25-0626-1400     //// jwc 25-0325-1600 obsolete: quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("C:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",P:" + convertToText(port_Id_In) + ",D:" + convertToText(servoArm_DegreesInDirection_Enum_In)), quest_Debug_Show_Enum.Dashboard_OLED)
    ...
    export function quest_Set_Degrees_By_Integer_ForServoArm_SMALL_Func(port_Id_In: quest_PortSingle_ServoArmBeam_PortId_Enum, servoArm_DegreesInDirection_Int_In: number, debug_Show_In: quest_Debug_Show_Enum): void {
        ...
        switch (port_Id_In) {
            case quest_PortSingle_ServoArmBeam_PortId_Enum.S7_ServoArm_Left:
                ...
                wuKong.setServoAngle(wuKong.ServoTypeList._270, wuKong.ServoList.S7, servoArm_Degrees_Local)
                // jwc 26-0710-2300: DriverDashboard (ETA) capture for OLED AL row
                servoArm_Degrees_S7_Left_QuestGlobal = "" + servoArm_DegreesInDirection_Int_In
                //// jwc 25-0626-1400 if (network_Send_DataOfBot_ToXrayDashboard_OnRemoteDisplay_OnOff_Enum_QuestGlobal == quest_Toggle_OnOff_Enum.On) {
                //// jwc 25-0626-1400     //// jwc y quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("A:" + convertToText(network_GroupChannel_OfXrayDashboard_OnRemoteDisplay_BASE0_INT_QUESTGLOBAL +",L:" + convertToText(powerLeftIn) +",R:" + convertToText(powerRightIn)), quest_Debug_Show_Enum.Dashboard_OLED)
                //// jwc 25-0626-1400     //// jwc ny quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("C:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",Arm_Port:" + convertToText(port_Id_In) + ",Arm_Deg:" + convertToText(servoArm_DegreesInDirection_Enum_In)), quest_Debug_Show_Enum.Dashboard_OLED)
                //// jwc 25-0626-1400     //// jwc 25-0325-1600 obsolete: quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("C:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",P:" + convertToText(port_Id_In) + ",D:" + convertToText(servoArm_DegreesInDirection_Enum_In)), quest_Debug_Show_Enum.Dashboard_OLED)
            ...
            case quest_PortSingle_ServoArmBeam_PortId_Enum.S6_ServoArm_Right:
                ...
                wuKong.setServoAngle(wuKong.ServoTypeList._270, wuKong.ServoList.S6, servoArm_Degrees_Local)
                // jwc 26-0710-2300: DriverDashboard (ETA) capture for OLED AR row
                servoArm_Degrees_S6_Right_QuestGlobal = "" + servoArm_DegreesInDirection_Int_In
                //// jwc 25-0626-1400 if (network_Send_DataOfBot_ToXrayDashboard_OnRemoteDisplay_OnOff_Enum_QuestGlobal == quest_Toggle_OnOff_Enum.On) {
                //// jwc 25-0626-1400     //// jwc y quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("A:" + convertToText(network_GroupChannel_OfXrayDashboard_OnRemoteDisplay_BASE0_INT_QUESTGLOBAL +",L:" + convertToText(powerLeftIn) +",R:" + convertToText(powerRightIn)), quest_Debug_Show_Enum.Dashboard_OLED)
                //// jwc 25-0626-1400     //// jwc ny quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("C:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",Arm_Port:" + convertToText(port_Id_In) + ",Arm_Deg:" + convertToText(servoArm_DegreesInDirection_Enum_In)), quest_Debug_Show_Enum.Dashboard_OLED)
                //// jwc 25-0626-1400     //// jwc 25-0325-1600 obsolete: quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("C:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",P:" + convertToText(port_Id_In) + ",D:" + convertToText(servoArm_DegreesInDirection_Enum_In)), quest_Debug_Show_Enum.Dashboard_OLED)
