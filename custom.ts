...
namespace quest_Motors {
    ...
    */
    ...
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall/**
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall* quest_Set_AutoDegrees_ForServoArm_BIG_Func
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall* @param port_Id_In quest_PortGroup_ServoArm_PortId_Enum
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall* @param servoArm_DegreesInDirection_Enum_In quest_ServoArm_DegreesInDirection_Enum
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall* @param debug_Show_In quest_Debug_Show_Enum
//// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall*/
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall//% block="set auto_servo_arm_BIG|* port_Id_In: $port_Id_In|* servoArm_DegreesInDirection_Enum_In: $servoArm_DegreesInDirection_Enum_In|* debug_Show_In: $debug_Show_In|Key Tips: |  - OrangeW.ire=BlueP.in(S), RedW.=RedP.(V), BrownW.=BlackP.(G)|  - S=Signal, V=Volts, G=Ground|  - When Wiring, Power-Off -&- When Operating, Battery >= 75\\%"
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall//% weight=74 blockGap=8
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall//% inlineInputMode=external
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmallexport function quest_Set_AutoDegrees_ForServoArm_BIG_Func(port_Id_In: quest_PortSingle_ServoArmBeam_PortId_Enum, servoArm_DegreesInDirection_Enum_In: quest_ServoArm_DegreesInDirection_Enum, debug_Show_In: quest_Debug_Show_Enum): void {
//// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    ///jwc y if(quest_Debug_Show_Enum)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    ///jwc y basic.showIcon(IconNames.SmallHeart)
//// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    let network_Message_Str = ""
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    let message_Mini_Network_Str = ""
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    let message_Full_Display_Str = ""
//// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall
//// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    //// jwc 25-0809-1450 y: //// jwc 25-0809-1400 270/360 = 0.75 >> 0 x 0.75 = 0 | 45 x 0.75 = 33.75 } 90 x 0.75 - 67.5 | 180 x 0.75 = 135 \/\/
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    //// jwc 25-0809-1450 y: ////
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    //// jwc 25-0809-1450 y: wuKong.setServoAngle(wuKong.ServoTypeList._270, wuKong.ServoList.S7, 0)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    //// jwc 25-0809-1450 y: wuKong.setServoAngle(wuKong.ServoTypeList._270, wuKong.ServoList.S6, 0)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    //// jwc 25-0809-1450 y: serial.writeLine('* test.ts: 12: ' + convertToText(0))
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    //// jwc 25-0809-1450 y: quest_Timer.quest_Set_ContinueCurrentState_CountdownTimer_Func(2, quest_Time_Units_Enum.Seconds) //// jwc 3,2,1, 0.5
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    //// jwc 25-0809-1450 y: 
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    //// jwc 25-0809-1450 y: wuKong.setServoAngle(wuKong.ServoTypeList._270, wuKong.ServoList.S7, 33.75)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    //// jwc 25-0809-1450 y: wuKong.setServoAngle(wuKong.ServoTypeList._270, wuKong.ServoList.S6, 33.75)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    //// jwc 25-0809-1450 y: serial.writeLine('* test.ts: 12: ' + convertToText(33.75))
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    //// jwc 25-0809-1450 y: quest_Timer.quest_Set_ContinueCurrentState_CountdownTimer_Func(2, quest_Time_Units_Enum.Seconds) //// jwc 3,2,1, 0.5
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    //// jwc 25-0809-1450 y: 
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    //// jwc 25-0809-1450 y: wuKong.setServoAngle(wuKong.ServoTypeList._270, wuKong.ServoList.S7, 67.5)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    //// jwc 25-0809-1450 y: wuKong.setServoAngle(wuKong.ServoTypeList._270, wuKong.ServoList.S6, 67.5)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    //// jwc 25-0809-1450 y: serial.writeLine('* test.ts: 12: ' + convertToText(67.5))
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    //// jwc 25-0809-1450 y: quest_Timer.quest_Set_ContinueCurrentState_CountdownTimer_Func(2, quest_Time_Units_Enum.Seconds) //// jwc 3,2,1, 0.5
//// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall
//// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    let servoArm_Degrees_Local = 0
//// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    switch (port_Id_In) {
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall        case quest_PortSingle_ServoArmBeam_PortId_Enum.S7_ServoArm_Left:
//// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            switch (servoArm_DegreesInDirection_Enum_In) {
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                case quest_ServoArm_DegreesInDirection_Enum.Degree_000_Down:
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    //// jwc y servoArm_Degrees_Local = 90
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    //// jwc 25-0625-1800 servoArm_Degrees_Local = 135
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    //// jwc 25-0808-1800 New Servo Positoning \/ 
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    servoArm_Degrees_Local = 0
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    break  // out of these case statements
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                case quest_ServoArm_DegreesInDirection_Enum.Degree_045_Up_Half:
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    //// jwc 25-0625-1800 servoArm_Degrees_Local = 180
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    //// jwc 25-0808-1800 New Servo Positoning \/ 
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    servoArm_Degrees_Local = 33.75
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    break  // out of these case statements
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                case quest_ServoArm_DegreesInDirection_Enum.Degree_090_Up_Full:
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    //// jwc y servoArm_Degrees_Local = 45
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    //// jwc 25-0625-1800 servoArm_Degrees_Local = 90
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    //// jwc 25-0808-1800 New Servo Positoning \/ 
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    servoArm_Degrees_Local = 67.5
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    break  // out of these case statements
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            }
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0720-1800 switch from large-gray to small-gray: wuKong.setServoAngle(wuKong.ServoTypeList._360, wuKong.ServoList.S7, servoArm_Degrees_Local)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            wuKong.setServoAngle(wuKong.ServoTypeList._270, wuKong.ServoList.S7, servoArm_Degrees_Local)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0626-1400 if (network_Send_DataOfBot_ToXrayDashboard_OnRemoteDisplay_OnOff_Enum_QuestGlobal == quest_Toggle_OnOff_Enum.On) {
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0626-1400     //// jwc y quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("A:" + convertToText(network_GroupChannel_OfXrayDashboard_OnRemoteDisplay_BASE0_INT_QUESTGLOBAL +",L:" + convertToText(powerLeftIn) +",R:" + convertToText(powerRightIn)), quest_Debug_Show_Enum.Dashboard_OLED)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0626-1400     //// jwc ny quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("C:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",Arm_Port:" + convertToText(port_Id_In) + ",Arm_Deg:" + convertToText(servoArm_DegreesInDirection_Enum_In)), quest_Debug_Show_Enum.Dashboard_OLED)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0626-1400     //// jwc 25-0325-1600 obsolete: quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("C:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",P:" + convertToText(port_Id_In) + ",D:" + convertToText(servoArm_DegreesInDirection_Enum_In)), quest_Debug_Show_Enum.Dashboard_OLED)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0626-1400     quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func( "C:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",L_S7:" + convertToText(servoArm_DegreesInDirection_Enum_In)), quest_Debug_Show_Enum.Dashboard_OLED)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0626-1400 }
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0627-0900 quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("C:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",L_S7:" + convertToText(servoArm_DegreesInDirection_Enum_In)))
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0628-1400 quest_Dashboard.quest_Dashboard_Network_SendData_WithMyBotHeader_Func("C:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",L_S7:" + convertToText(servoArm_DegreesInDirection_Enum_In)))
//// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            message_Mini_Network_Str = "7" + convertToText(servoArm_DegreesInDirection_Enum_In)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            message_Full_Display_Str = "Arm_L: " + convertToText(servoArm_DegreesInDirection_Enum_In)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            // Special Location: For 'Arm_L" 
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            quest_Dashboard.quest_Show_String_For_Oled_SmallFont_Func(message_Full_Display_Str, 0, 3)
//// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0628-1400 if (_debug_Serial_Print_Bool_QuestGlobal) {
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0628-1400     //// jwc o serial.writeLine("* quest_Set_AutoDegrees_ForServoArm_Func: " + powerLeftIn + " " + powerRightIn + " >> " + motor_Power_L + " " + motor_Power_R)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0628-1400     //// jwc 25-0325-1600 obsolete: serial.writeLine("* quest_Set_AutoDegrees_ForServoArm_Func: " + "C:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",Arm_Port:" + convertToText(port_Id_In) + ",Arm_Deg:" + convertToText(servoArm_DegreesInDirection_Enum_In)))
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0628-1400     //// jwc y serial.writeLine("* quest_Set_AutoDegrees_ForServoArm_Func: " + "C:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",L_S7:" + convertToText(servoArm_DegreesInDirection_Enum_In)))
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0628-1400     serial.writeLine("* quest_Set_AutoDegrees_ForServoArm_Func: " + message_Full_Display_Str)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0628-1400 }
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            break  // out of these case statements
//// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall        case quest_PortSingle_ServoArmBeam_PortId_Enum.S6_ServoArm_Right:
//// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            switch (servoArm_DegreesInDirection_Enum_In) {
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                case quest_ServoArm_DegreesInDirection_Enum.Degree_000_Down:
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    //// jwc y servoArm_Degrees_Local = 90
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    //// jwc 25-0625-1800 servoArm_Degrees_Local = 45
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    //// jwc 25-0808-1800 New Servo Positoning \/ 
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    servoArm_Degrees_Local = 0
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    break  // out of these case statements
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                case quest_ServoArm_DegreesInDirection_Enum.Degree_045_Up_Half:
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    //// jwc 25-0625-1800 servoArm_Degrees_Local = 0
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    //// jwc 25-0808-1800 New Servo Positoning \/ 
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    servoArm_Degrees_Local = 33.75
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    break  // out of these case statements
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                case quest_ServoArm_DegreesInDirection_Enum.Degree_090_Up_Full:
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    //// jwc y servoArm_Degrees_Local = 135
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    //// jwc 25-0625-1800 servoArm_Degrees_Local = 90
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    //// jwc 25-0808-1800 New Servo Positoning \/ 
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    servoArm_Degrees_Local = 67.5
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall                    break  // out of these case statements
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            }
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0720-1800 switch from large-gray to small-gray: wuKong.setServoAngle(wuKong.ServoTypeList._360, wuKong.ServoList.S6, servoArm_Degrees_Local)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            wuKong.setServoAngle(wuKong.ServoTypeList._270, wuKong.ServoList.S6, servoArm_Degrees_Local)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0626-1400 if (network_Send_DataOfBot_ToXrayDashboard_OnRemoteDisplay_OnOff_Enum_QuestGlobal == quest_Toggle_OnOff_Enum.On) {
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0626-1400     //// jwc y quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("A:" + convertToText(network_GroupChannel_OfXrayDashboard_OnRemoteDisplay_BASE0_INT_QUESTGLOBAL +",L:" + convertToText(powerLeftIn) +",R:" + convertToText(powerRightIn)), quest_Debug_Show_Enum.Dashboard_OLED)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0626-1400     //// jwc ny quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("C:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",Arm_Port:" + convertToText(port_Id_In) + ",Arm_Deg:" + convertToText(servoArm_DegreesInDirection_Enum_In)), quest_Debug_Show_Enum.Dashboard_OLED)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0626-1400     //// jwc 25-0325-1600 obsolete: quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("C:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",P:" + convertToText(port_Id_In) + ",D:" + convertToText(servoArm_DegreesInDirection_Enum_In)), quest_Debug_Show_Enum.Dashboard_OLED)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0626-1400      quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("D:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",R_S6:" + convertToText(servoArm_DegreesInDirection_Enum_In)), quest_Debug_Show_Enum.Dashboard_OLED)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0626-1400 }
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0627-0900 quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("D:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",R_S6:" + convertToText(servoArm_DegreesInDirection_Enum_In)))
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0628-1400 quest_Dashboard.quest_Dashboard_Network_SendData_WithMyBotHeader_Func("D:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",R_S6:" + convertToText(servoArm_DegreesInDirection_Enum_In)))
//// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            message_Mini_Network_Str = "6" + convertToText(servoArm_DegreesInDirection_Enum_In)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            message_Full_Display_Str = "Arm_R: " + convertToText(servoArm_DegreesInDirection_Enum_In)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            // Special Location: For 'Arm_R"
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            quest_Dashboard.quest_Show_String_For_Oled_SmallFont_Func(message_Full_Display_Str, 10, 3)
//// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0628-1400 if (_debug_Serial_Print_Bool_QuestGlobal) {
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0628-1400     //// jwc o serial.writeLine("* quest_Set_AutoDegrees_ForServoArm_Func: " + powerLeftIn + " " + powerRightIn + " >> " + motor_Power_L + " " + motor_Power_R)
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0628-1400     //// jwc 25-0325-1600 obsolete: serial.writeLine("* quest_Set_AutoDegrees_ForServoArm_Func: " + "C:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",Arm_Port:" + convertToText(port_Id_In) + ",Arm_Deg:" + convertToText(servoArm_DegreesInDirection_Enum_In)))
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0628-1400     serial.writeLine("* quest_Set_AutoDegrees_ForServoArm_Func: " + "D:" + convertToText(network_GroupChannel_MyBotId_Base0_Int_QuestGlobal + ",R_S6:" + convertToText(servoArm_DegreesInDirection_Enum_In)))
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            //// jwc 25-0628-1400 }
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall            break  // out of these case statements 
    //// jwc 25-0922-0240 yy replace w/ ServoArm_GraySmall    }
