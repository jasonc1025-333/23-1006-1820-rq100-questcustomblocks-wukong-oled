...
//   * network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal
//   * quest_Public_Variables_N_Constants.network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal_01
//   * quest_Dashboard.network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal_11
...
let network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal = 0
let network_GroupChannelOfMe_AutoSet_Default_Base0_Int_QuestGlobal = 0


//// jwc n public network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal
//// jwc n var network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal
...
input.onLogoEvent(TouchButtonEvent.LongPressed, function() {
    ...
    basic.showString("Z")
    basic.showNumber(network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal)
...
namespace quest_Public_Variables_N_Constants {
    export let network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal_01 = 0
}
//// jwc n NOT WORK, SINCE ONLY CREATES 'PROTOTYPE': class quest_Public_Variables_N_Constants_01 {
//// jwc n NOT WORK, SINCE ONLY CREATES 'PROTOTYPE':     public network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal_02: number
//// jwc n NOT WORK, SINCE ONLY CREATES 'PROTOTYPE': }


//// jwc obsolete: let network_Send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_Quest_Global = quest_Toggle_OnOff_Enum.On
...
namespace quest_Dashboard {
    ...
    export let network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal_11 = 0

    //// jwc n export network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal_03
    ...
    */
    ...
    //// jwc yy export function quest_Send_DataOfBot_ToXrayDashboardOfMb_Func(network_GroupChannelOfMe_Base0_IntIn: number, send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_In: boolean, debug_Show_In: quest_Debug_Show_Enum): void {
     ...
     * @param send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_In quest_Toggle_OnOff_Enum
     * @param debug_Show_In quest_Debug_Show_Enum
     *
     */
    // '\\' = escape character to deactivate following special character
    //% block="set quest\\_Send\\_LoginOfBot\\_ToXrayDashboardOfMb\\_Func:|* network_GroupChannelOfMe_Base0_IntIn: $network_GroupChannelOfMe_Base0_IntIn|* send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_In: $send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_In|* debug_Show_In: $debug_Show_In"
    //% network_GroupChannelOfMe_Base0_IntIn.min=0 network_GroupChannelOfMe_Base0_IntIn.max=254
    //% weight=50 blockGap=8
    //% inlineInputMode=external
    //// jwc n default only seems to work w/ number: export function quest_Send_LoginOfBot_ToXrayDashboardOfMb_Func(network_GroupChannelOfMe_Base0_IntIn: number, send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_In: boolean = true, debug_Show_In: quest_Debug_Show_Enum = quest_Debug_Show_Enum.Dashboard_OLED): void {
    export function quest_Send_LoginOfBot_ToXrayDashboardOfMb_Func(network_GroupChannelOfMe_Base0_IntIn: number, send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_In: quest_Toggle_OnOff_Enum, debug_Show_In: quest_Debug_Show_Enum): void {
        ///jwc y if(quest_Debug_Show_Enum)
        ///jwc y basic.showIcon(IconNames.SmallHeart)

        network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal = network_GroupChannelOfMe_Base0_IntIn
        ...
        serial.writeLine("* 11: " + convertToText(network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal) + " | " + convertToText(network_Send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_Quest_Global))

        let network_Message_Str = ""

        //// jwc yy: allow '1' be legal for simplicity: if (network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal == 0 || network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal == 1 || network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal == 255) {
        //// jwc oy if (network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal == 0 || network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal == 255) {
        // * Unconditionally create 4-Digit Z#### to be separate from Staff-Assigned GroupChannel_BotId_# \/
        //// jwc ? if (true) {
        // * For Autonomous, most likely 'network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal' == 0, so auto-create one
        if (network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal <= 0 || network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal >= 255) {

            //// jwc n network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal = convertToText(control.deviceSerialNumber()).substr(convertToText(control.deviceSerialNumber()).length - 2, 2)
            //// jwc y increase to 3-digits: serial.writeLine("* 20- " + convertToText(network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal) + " " + convertToText(Math.abs(control.deviceSerialNumber() % 100)) + " " + convertToText(100 + Math.abs(control.deviceSerialNumber() % 100)) + " " + convertToText(control.deviceSerialNumber()))
            serial.writeLine("* 20- " + convertToText(network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal) + " " + convertToText(Math.abs(control.deviceSerialNumber() % 1000)) + " " + convertToText(control.deviceSerialNumber()))
            //// jwc y increase to 3-digits \/ network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal = 100 + Math.abs(control.deviceSerialNumber() % 100)
            //// jwc yy network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal = Math.abs(control.deviceSerialNumber() % 1000)
           
            //// TODO jwc add leading zeroes
            network_GroupChannelOfMe_AutoSet_Default_Base0_Int_QuestGlobal = Math.abs(control.deviceSerialNumber() % 1000)

            serial.writeLine("* 20+ " + "Z" + convertToText(network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal))
        }

        //// jwc only show on demand, like long-press-Logo: // Show 'network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal'
        //// jwc only show on demand, like long-press-Logo: basic.showString(convertToText(network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal))

        quest_Public_Variables_N_Constants.network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal_01 = network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal
        //// jwc ? quest_Public_Variables_N_Constants_01.prototype.network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal_02 = network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal
        network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal_11 = network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal
        ...
        switch (debug_Show_In) {
            case quest_Debug_Show_Enum.Dashboard_OLED:
                ...
                quest_Dashboard.quest_Show_String_For_Oled_SmallFont_Func(convertToText(network_GroupChannelOfMe_Base0_IntIn) + " " + convertToText(send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_In) + " " + convertToText(debug_Show_In), 0, 0)
                quest_Dashboard.quest_Show_String_For_Oled_SmallFont_Func(convertToText(network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal) + " " + convertToText(network_Send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_Quest_Global) + " " + convertToText(debug_Show_In), 0, 1)

                quest_Dashboard.quest_Show_String_For_Oled_SmallFont_Func(convertToText(network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal) + " " + convertToText(network_Send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_Quest_Global) + " " + convertToText(control.deviceSerialNumber()), 0, 2)

                serial.writeLine('* 30: ' + convertToText(network_GroupChannelOfMe_Base0_IntIn)            + " " + convertToText(send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_In)         + " " + convertToText(debug_Show_In))
                serial.writeLine('* 31: ' + convertToText(network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal) + " " + convertToText(network_Send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_Quest_Global) + " " + convertToText(debug_Show_In))
            ...
            default:
                if (_debug_Serial_Print_Bool_QuestGlobal) {
                    serial.writeLine("* ERROR: 25-0208-0300: quest_Send_LoginOfBot_ToXrayDashboardOfMb_Func: " + network_GroupChannelOfMe_Base0_IntIn + " " + send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_In + " " + debug_Show_In)
                }
                break
        }
        ...
        if (true) {
            ...
            // network_Message_Str = "" + convertToText(network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal) + ":" + convertToText(input.lightLevel()) + ":" + convertToText(input.temperature()) + ":" + convertToText(0)
            ...
            // 'Z:' = Register Header
            // * 
            network_Message_Str = "Z" + convertToText(network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal) + ",L:+" + convertToText(randint(1, 100)) + ",R:-" + convertToText(randint(1, 100))
            quest_Note_3.quest_Show_String_For_Note_Big_Func(
                "Network_Message Max Length or will be cut off"
            )
            if (network_Message_Str.length > network_Message_LENGTH_MAX_INT_QUESTGLOBAL) {
        ...
        switch (portIdsIn) {
            case quest_PortGroup_BlueRedBlack_PortIds_Enum.S1_MotorLeft__S0_MotorRight:
                ...
                if (network_Send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_Quest_Global == quest_Toggle_OnOff_Enum.On) {
                    ...
                    quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("A:" + convertToText(network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal + ",L:" + convertToText(powerLeftIn) + ",R:" + convertToText(powerRightIn)), quest_Debug_Show_Enum.Dashboard_OLED)
                }
                if (_debug_Serial_Print_Bool_QuestGlobal) {
            ...
            case quest_PortGroup_BlueRedBlack_PortIds_Enum.S3_MotorLeft__S2_MotorRight:
                ...
                if (network_Send_DataOfBot_ToXrayDashboardOfMb_OnOff_Enum_Quest_Global == quest_Toggle_OnOff_Enum.On) {
                    ...
                    quest_Dashboard.quest_Send_DataOfBot_ToXrayDashboardOfMb_Func("D:" + convertToText(network_GroupChannelOfMe_ManualSet_Override_Base0_Int_QuestGlobal + ",L:" + convertToText(powerLeftIn) + ",R:" + convertToText(powerRightIn)), quest_Debug_Show_Enum.Dashboard_OLED)
                }
                if (_debug_Serial_Print_Bool_QuestGlobal) {
                    serial.writeLine("* quest_Set_PowerMotorsViaBlueRedBlackPins_Func: " + powerLeftIn + " " + powerRightIn + " >> " + motor_Power_L + " " + motor_Power_R)
                }
